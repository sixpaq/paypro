...
class Client {
   ...
   * @param {callback} cb 
   */
  createPayment({ consumerIban, amount, description, payMethod, consumerName, consumerFirstname, consumerAddress, consumerCity, consumerEmail, testMode, returnUrl, cancelUrl, postbackUrl }, cb) {
   ...
   * @param {callback} cb 
   */
  createProductPayment({ productId, consumerIban, amount, description, payMethod, consumerName, consumerFirstname, consumerAddress, consumerCity, consumerEmail, testMode, returnUrl, cancelUrl, postbackUrl }, cb) {
